...
# mute audio when headphone unplugged
# Credit: https://geekeefy.wordpress.com/2017/03/31/powershell-auto-mute-when-headphones-are-accidently-unplugged/
...
While($true)
{
    ...
    $EventType = $Event.sourceargs.newevent | Sort-Object TIME_CREATED -Descending | Select-Object EventType -ExpandProperty EventType -First 1
