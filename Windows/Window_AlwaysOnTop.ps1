...
# source https://raw.githubusercontent.com/bkfarnsworth/Always-On-Top-PS-Script/master/Always_On_Top.ps1
...
function Get-OpenedApplication {
    Get-Process |
...
function Set-ApplicationOnTop{
    ...
    $openApplications = Get-OpenedApplication
...
function New-DropDownBox {
    PARAM($openApplications)
...
$openApplications = Get-OpenedApplication
$chosenApplication = New-DropDownBox -openApplications $openApplications
Set-ApplicationOnTop ($chosenApplication)
